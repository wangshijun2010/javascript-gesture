...
// Classes that we need to implement Gesture
// Gesture.Point
// Gesture.Template gesture template to match
// Gesture.Result probability distribution of a stroke amoung a seril of templates

// Centroid: an special case of a point
var Centroid = function(x,y) {
	this.x = x;
	this.y = y;
}

// Point: 2 dimension point object
...
// Template: with a label and point collection
...
Iterator.prototype = {
	next: function() {
		var element = this.collection[this.index];
		this.index++;
		return element;
	},
	hasNext: function() {
		if (this.collection[this.index+1] == undefined) {
			return true;
		}
		return false;
	},
...
Gesture.prototype = {
	...
	// This can be improved using a more smater algorithm
